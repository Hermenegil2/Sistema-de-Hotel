...
import py.com.hoteleria.informeControlador.ListadoServicioControlador;
...
public class ListadoServicio extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadoServicio dialog = new ListadoServicio();
	...
	public ListadoServicio() {
		...
		tableServicio.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(95, 158, 160), new Color(95, 158, 160), new Color(95, 158, 160), new Color(95, 158, 160)));
		tableServicio.setFont(new Font("SansSerif", Font.BOLD, 12));
		tableServicio.setBackground(new Color(0, 191, 255));
		...
		tableServicio.getColumnModel().getColumn(0).setPreferredWidth(43);
		tableServicio.getColumnModel().getColumn(1).setPreferredWidth(256);
		tableServicio.getColumnModel().getColumn(2).setPreferredWidth(50);
		tableServicio.getColumnModel().getColumn(3).setPreferredWidth(239);
		...
		ListadoServicioControlador controlador=new ListadoServicioControlador(this);
